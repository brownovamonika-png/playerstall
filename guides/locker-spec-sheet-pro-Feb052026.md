## Pro Locker – Spec Sheet (Feb 05, 2026)
...
- **All widths (18"–32"):** $549.00 per locker
...
- Selectable width: 18", 20", 22", 24", 26", 28", 30", 32" (same base price $549.00 for all).
...
**Page Location**
- Astro page: `src/pages/product-pro-locker.astro`
