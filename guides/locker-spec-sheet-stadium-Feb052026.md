## Stadium Locker – Spec Sheet (Feb 05, 2026)
...
- **All widths (18"–32"):** $599.00 per locker

**Material**
- Premium plywood core with melamine or equivalent surface
...
**Standard Features**
- Premium construction for elite and professional facilities
...
- Selectable width: 18", 20", 22", 24", 26", 28", 30", 32" (same base price $599.00 for all).
...
**Page Location**
- Astro page: `src/pages/product-stadium-locker.astro` (or link from Services/Shop)
