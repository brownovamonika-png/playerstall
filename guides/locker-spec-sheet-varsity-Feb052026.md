## Varsity Locker – Spec Sheet (Feb 05, 2026)
...
- **All widths (18"–32"):** $449.00 per locker

**Material**
- 3/4" birch wood with premium finish
...
**Standard Features**
- 3/4" birch wood with premium melamine-style finish
...
- Selectable width: 18", 20", 22", 24", 26", 28", 30", 32" (same base price $449.00 for all).
...
**Page Location**
- Astro page: `src/pages/product-varsity-locker.astro` (or link from Services/Shop)
