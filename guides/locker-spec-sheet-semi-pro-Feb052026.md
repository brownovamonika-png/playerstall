## Semi Pro Locker – Spec Sheet (Feb 05, 2026)

**Model / Name**
- Semi Pro wood locker
...
- **All widths (18"–32"):** $349.00 per locker

**Material**
- 3/4" birch wood construction
- Durable, moisture-resistant finish
- Modular design for easy repair or replacement of components
...
**Standard Features**
- 3/4" birch wood with professional finish
- Engineered for athletic locker rooms
- 14" high foot locker for seating and storage
- Lifetime guarantee
...
- Selectable width: 18", 20", 22", 24", 26", 28", 30", 32" (same base price $349.00 for all).
...
**Page Location**
- Astro page: `src/pages/product-semi-pro-locker.astro` (or link from Services/Shop)
