...
smtp_user = os.getenv("RANKING_SMTP_USER", "monika@customsportslockers.com")
...
if not config_ok:
    ...
    print("  export RANKING_SMTP_USER='monika@customsportslockers.com'")
...
print()
print("Next steps:")
print("  1. Check what email provider hosts monika@customsportslockers.com")
