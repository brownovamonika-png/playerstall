import"./hoisted.B74hoRpg.js";document.addEventListener("DOMContentLoaded",function(){function r(){const e=localStorage.getItem("playerstall_cart");return e?JSON.parse(e):[]}function y(e){localStorage.setItem("playerstall_cart",JSON.stringify(e)),g(),u()}function g(){const n=r().reduce((s,l)=>s+l.quantity,0),c=document.querySelector(".cart-count");c&&(c.textContent=n),window.dispatchEvent(new CustomEvent("cartUpdated",{detail:{count:n}}))}function u(){const e=r(),n=document.getElementById("cart-items-container"),c=document.getElementById("cart-empty-message"),s=document.getElementById("cart-items-body"),l=document.getElementById("cart-subtotal"),h=document.getElementById("cart-total");if(e.length===0){n&&(n.style.display="none"),c&&(c.style.display="block");return}n&&(n.style.display="block"),c&&(c.style.display="none");let d=0,x="";e.forEach((t,i)=>{const a=t.price*t.quantity;d+=a,x+=`
					<tr class="cart_item">
