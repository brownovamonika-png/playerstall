import"./hoisted.DpXtvfh1.js";document.addEventListener("DOMContentLoaded",function(){function l(){const t=localStorage.getItem("playerstall_cart");return t?JSON.parse(t):[]}function y(t){localStorage.setItem("playerstall_cart",JSON.stringify(t)),h(),p()}function h(){const e=l().reduce((o,c)=>o+c.quantity,0),n=document.querySelector(".cart-count");n&&(n.textContent=e),window.dispatchEvent(new CustomEvent("cartUpdated",{detail:{count:e}}))}function p(){const t=l(),e=document.getElementById("cart-items-container"),n=document.getElementById("cart-empty-message"),o=document.getElementById("cart-items-body"),c=document.getElementById("cart-subtotal"),u=document.getElementById("cart-total");if(t.length===0){e&&(e.style.display="none"),n&&(n.style.display="block");return}e&&(e.style.display="block"),n&&(n.style.display="none");let i=0,x="";t.forEach((a,s)=>{const r=a.price*a.quantity;i+=r,x+=`
					<tr class="cart_item">
